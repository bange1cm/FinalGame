 ...
 * 
 * ContactPage.java
 * This is the Contact page of the website which contains a virus and extends GridPane so an instance can be created and added to the stage in WebsiteTemplate
 */
...
public class ContactPage extends GridPane implements HasBug{
	...
	// counter method to keep track of clicks, lagwitch bug is revealed after 3
	// clicks
