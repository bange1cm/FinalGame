 ...
 * 
 * Reviews.java
 * The reviews page of the website which extends BorderPane, contains a virus, and can be created as an instance so it can be added to the scene in WebsiteTemplate
 */
...
public class Reviews extends BorderPane implements HasBug {
	...
	public Reviews() {
		...
		Label review2 = new Label(
				"5/5 Stars: This is the best White Plain No Text Men’s Women’s Unisex Shirt ever! It works so well and was so cheap. I’ll be buying this again!\n⭐⭐⭐⭐⭐");
		...
		bugButton.setStyle("-fx-text-fill: #FF0000;" + "    -fx-border-color: #FF0000;" + "    -fx-border-radius: 20;"
				+ "    -fx-background-radius: 20;" + "    -fx-padding: 5;");
		scam.getChildren().addAll(text, bugButton);
		scam.setStyle("-fx-border-color: red;" + "    -fx-border-insets: 5;" + "    -fx-border-width: 3;"
