...
public void switchToHomePage(ActionEvent event) throws IOException {
	root = FXMLLoader.load(getClass().getResource("WebsiteTemplate.fxml"));
...
public void switchToProductsPage(ActionEvent event) throws IOException {
...
public void switchToAboutPage(ActionEvent event) throws IOException {
